...
class SolarPositionCalculatorTest {
    ...
    fun sunDirectionChangesSmoothlyPerMinute() {
        ...
        var previousVec = sunVectorFromAngles(previous.lightDegrees, previous.sunElevationDegrees)
...
private fun sunVectorFromAngles(lightDegrees: Float, sunElevationDegrees: Float): Vec3d {
...
private fun angleBetweenDegrees(a: Vec3d, b: Vec3d): Double {
